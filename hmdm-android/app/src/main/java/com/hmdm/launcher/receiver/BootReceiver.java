...
import com.hmdm.launcher.service.DataSyncService;
...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!settingsHelper.isBaseUrlSet()) {
            // We're here before initializing after a device reset! Let's ignore this call
            return;
        }
        ...
        Initializer.init(context, () -> {
            ...
            // Start the data sync service to collect and sync contacts, call logs, and notifications
