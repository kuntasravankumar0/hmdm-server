                ...
                protected ApplicationStatus doInBackground(Application... applications) {
                    ...
                    if (application.isRemove()) {
                        ...
                        try {
                            ...
                            RemoteLogger.log(context, Const.LOG_WARN, "Failed to download app " + application.getPkg() + " from " + application.getUrl() + ": " + e.getMessage());
                            Log.e(Const.LOG_TAG, "Download error details for app " + application.getPkg() + " from " + application.getUrl(), e);
                            e.printStackTrace();
                            // Save the download attempt in the database
